...
\thesistitle{Aplicación de control y monitoreo para edificios sustentables} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
\author{Juan Carlos Bampini Basualdo} % Tu nombre, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \authorname
